Contributing to zerodb Core
============================

The zerodb Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zerodb Core project, and is not to be
confused with overall zerodb Network Protocol consensus changes.

Whether a pull request is merged into zerodb Core rests with the project merge
...
Patches that change zerodb consensus rules are considerably more involved than
...
Where a patch set proposes to change the zerodb consensus, it must have been
...
The project leader is the release manager for each zerodb Core release.
