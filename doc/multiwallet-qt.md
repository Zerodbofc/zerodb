...
In order to support loading of multiple wallets in zerodb-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zerodb.cpp.
...
Changes to zerodb.cpp
----------------------
zerodb.cpp is the entry point into zerodb-qt, and as such, will require some minor modifications to provide hooks for
