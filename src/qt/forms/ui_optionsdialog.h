...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizezerodb = new QSpinBox(tabMain);
        anonymizezerodb->setObjectName(QStringLiteral("anonymizezerodb"));
        anonymizezerodb->setMinimum(100);
        anonymizezerodb->setMaximum(100000);
        anonymizezerodb->setSingleStep(100);
        anonymizezerodb->setValue(1000);

        horizontalLayout->addWidget(anonymizezerodb);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start zerodb after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start zerodb on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of zerodb to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the zerodb client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the zerodb network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting zerodb.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/zerodb-project/zerodb-project-translations", 0));
