                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("zerodb Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zerodb address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zerodb: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zerodb Core"), this);
    aboutAction->setStatusTip(tr("Show information about zerodb Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zerodb"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zerodb addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zerodb addresses"));
    ...
    openAction->setStatusTip(tr("Open a zerodb: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zerodb Core help message to get a list with possible zerodb command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zerodb Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zerodb network", "", count));
}
...
{
    QString strTitle = tr("zerodb Core"); // default title
