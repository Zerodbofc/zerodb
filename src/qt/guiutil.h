...
/** Utility functions used by the zerodb Qt UI.
 */
namespace GUIUtil
{
...
// Render zerodb addresses in monospace font
...
// Parse "zerodb:" URI into recipient object, return true on successful parsing
