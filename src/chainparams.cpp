...
static Checkpoints::MapCheckpoints mapCheckpoints =
      boost::assign::map_list_of(0, uint256("0xc19c0a3f9e613a75f6ae6724149cc3602ecd32ecf47d452861803077e38f841d"))

;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1519555563, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 43101;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // zerodb starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // zerodb: 1 day
        nTargetSpacing = 1 * 120;  // zerodb: 5 Min
        nLastPOWBlock = 1001;   //Last Pow Block
        nMaturity = 10;
        nMasternodeCountDrift = 4;
        nModifierUpdateBlock = 615800;
        nMaxMoneyOut = 20000000 * COIN;

        const char* pszTimestamp = "zerodb Core will create the biggest masternode network";
	...
	txNew.vout[0].scriptPubKey = CScript() << ParseHex("046901033eeb013d794cbbc51a8b6bc5fff90c86bd35d07e3edac2ed065cc738d6bc51ab0214747a0d774fd32c260e01bf8c5d398e981d53cce04785dd20b32d84") << OP_CHECKSIG;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1519555563;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 606831;
        ...
        assert(hashGenesisBlock == uint256("0xc19c0a3f9e613a75f6ae6724149cc3602ecd32ecf47d452861803077e38f841d"));
	...
	convertSeed6(vFixedSeeds, pnSeed6_main, ARRAYLEN(pnSeed6_main));
        vSeeds.push_back(CDNSSeedData("209.250.242.79", "209.250.242.79"));     // Amsterdam Seed
...
"04acfa23dd09e78a17c39ac6a947b016ea750af51c9d9b74eeb2da90c5bd526a271d68820626160ffbe9633e61dda2bdd2c7709a5c4285a1c87bbf2fc8396af498";
        ...
        nStartMasternodePayments = 1519580758; //  Sunday, 25 February 2018 17:45:58
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // zerodb: 1 day
        nTargetSpacing = 1 * 60;  // zerodb: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        nMasternodeCountDrift = 4;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 189); // Testnet zerodb addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 41);  // Testnet zerodb script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 219);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zerodb BIP32 pubkeys 
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x61)(0x60)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zerodb BIP32 prvkeys 
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x88)(0x57)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zerodb BIP44 
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // zerodb: 1 day
        nTargetSpacing = 1 * 60;        // zerodb: 1 minutes
