...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zerodb Core zerodb-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zerodb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zerodb transaction") + "\n" +
                               "  zerodb-tx [options] -create [commands]   " + _("Create hex-encoded zerodb transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zerodb transaction
