...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* zerodb features */
        {"zerodb", "masternode", &masternode, true, true, false},
        {"zerodb", "masternodelist", &masternodelist, true, true, false},
        {"zerodb", "mnbudget", &mnbudget, true, true, false},
        {"zerodb", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zerodb", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zerodb", "mnsync", &mnsync, true, true, false},
        {"zerodb", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zerodb", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zerodbd, or the -server option to zerodb-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zerodb-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43102/\n";
}
