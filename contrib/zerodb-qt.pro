...
RESOURCES += src/qt/zerodb.qrc src/qt/zerodb_locale.qrc

TRANSLATIONS += src/qt/locale/zerodb_bg.ts \
                src/qt/locale/zerodb_de.ts \
                src/qt/locale/zerodb_en.ts \
                src/qt/locale/zerodb_es.ts \
                src/qt/locale/zerodb_fi.ts \
                src/qt/locale/zerodb_fr.ts \
                src/qt/locale/zerodb_it.ts \
                src/qt/locale/zerodb_ja.ts \
                src/qt/locale/zerodb_pl.ts \
                src/qt/locale/zerodb_pt.ts \
                src/qt/locale/zerodb_ru.ts \
                src/qt/locale/zerodb_sk.ts \
                src/qt/locale/zerodb_sv.ts \
                src/qt/locale/zerodb_vi.ts \
                src/qt/locale/zerodb_zh_CN.ts \
                src/qt/locale/zerodb_zh_TW.ts
